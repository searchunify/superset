...
export const DetailPopup = ({
  ...
  const chartUrl = useMemo(() => {
      ...
      adhoc_filters: [
        {
          ...
          comparator: '2022-08-29 : 2022-08-30',
        },
      ],
    };
    ...
    return `/su-bi/superset/slice/115?standalone=1&extra_form_data=${encodedFormData}`;
  ...
  return (
    ...
    >
      <ChartContainer>
        {chartUrl ? (
          <Iframe
          src={`/su-bi/explore/?form_data=${encodeURIComponent(
            JSON.stringify({
              slice_id: 115,
              extra_form_data: {
                time_range: "2022-08-29 : 2022-08-30",
              },
            })
          )}&standalone=1`}
        />
        ...
        //  <Iframe
        //  src={`/su-bi/explore/?form_data=${encodeURIComponent(JSON.stringify({
        //   slice_id: 115,
        //   extra_form_data: {
        //     time_range: "2022-08-29 : 2022-08-30", // must be this field for temporal filters
        //   },
        // }
          //  extra_form_data: {
          //    adhoc_filters: [
